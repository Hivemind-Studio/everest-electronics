...
- Name: site.spec.ts >> Home page — Figma design sections >> renders Find Us (locations) section with both branches
- Location: tests-e2e/site.spec.ts:71:7
...
Locator: getByText('Gading Serpong')
Expected: visible
Error: strict mode violation: getByText('Gading Serpong') resolved to 2 elements:
    1) <h3 class="font-display text-xl font-bold text-ink">Gading Serpong</h3> aka getByRole('heading', { name: 'Gading Serpong' })
    2) <p class="mt-4 text-base leading-relaxed text-graphite">Ruko Glaze 1 Blok B No. 19, Gading Serpong, Kecam…</p> aka getByText('Ruko Glaze 1 Blok B No. 19,')

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText('Gading Serpong')
