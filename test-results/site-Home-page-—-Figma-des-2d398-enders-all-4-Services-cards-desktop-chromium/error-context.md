...
- Name: site.spec.ts >> Home page — Figma design sections >> renders all 4 Services cards
- Location: tests-e2e/site.spec.ts:29:7
...
Locator: getByRole('heading', { name: 'Clean & Service' })
Expected: visible
Error: strict mode violation: getByRole('heading', { name: 'Clean & Service' }) resolved to 2 elements:
    1) <h3 class="font-display text-xl font-bold text-ink">Clean & Service</h3> aka getByRole('link', { name: 'Clean & Service Perawatan' })
    2) <h3 class="mt-2 font-display text-2xl font-bold md:text-3xl">Promo Clean & Service Menyambut Ramadhan</h3> aka getByRole('heading', { name: 'Promo Clean & Service' })

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByRole('heading', { name: 'Clean & Service' })
